...
config :kirbs, KirbsWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: KirbsWeb.ErrorHTML, json: KirbsWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Kirbs.PubSub,
  live_view: [signing_salt: "5RiXFM+J"]
...
config :kirbs, Kirbs.Mailer, adapter: Swoosh.Adapters.Local
