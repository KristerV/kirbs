defmodule Kirbs.Resources.Item do
  ...
  attributes do
    ...
    attribute :status, :atom do
      allow_nil? false
      default :pending
      constraints one_of: [:pending, :ai_processed, :reviewed, :uploaded_to_yaga, :sold, :discarded, :upload_failed]
    end
  ...
  actions do
    default_accept [
      :bag_id, :brand, :size, :colors, :materials,
      :description, :quality, :suggested_category, :yaga_brand_id,
      :yaga_category_id, :yaga_colors_id_map, :yaga_materials_id_map,
      :yaga_condition_id, :ai_suggested_price, :ai_price_explanation,
      :listed_price, :sold_price, :status, :yaga_id, :yaga_slug, :upload_error
    ]
